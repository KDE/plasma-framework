...
void ViewPrivate::coronaPackageChanged(const Plasma::Package &package)
{
    q->setContainment(0);
    q->setSource(QUrl::fromLocalFile(package.filePath("views", "Desktop.qml")));
}
...
{
    d->coronaPackageChanged(package);
}
